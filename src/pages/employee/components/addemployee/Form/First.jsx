          ...
          <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 px-5 p-3">
            ...
            <div className="row mt-3">
              <div className="col-12">
                ...
                />
                {
                  errorExistType === 'email' ? <span className="text-red">User with this email already exists</span>
                  : null
                }
                {
                  !isValidEmail ? <span className="pl-3 text-red">Email not Valid</span> : null
                }
            ...
            <div className="row mt-3">
              ...
              <div className="form-group col-md-6">
                <label htmlFor="phone_number" className="text-bold">
                  Phone
                </label>
                <input
                  type="text"
            ...
            <div className="row mt-3">
              <div className="form-group col-md-6">
                ...
                <input
                  ...
                  value={isPermanentIdCard ? '' : data.identity_expired}
                  className="form-control input-border-grey"
                  id="identity_expired"
                  onChange={onChange}
